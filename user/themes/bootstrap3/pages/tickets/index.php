	...
	<div class="col-md-3">
		<div class="well well-sm">
			<div class="pull-right">
				<a href="<?php echo $config->get('address'); ?>/tickets/add/" class="btn btn-default"><?php echo safe_output($language->get('New Ticket')); ?></a>
			</div>
					...
					<table class="table table-striped table-bordered">
						...
						<tbody id="view-tickets-table-body">
							...
							<tr <?php if ($i % 2 == 0 ) { echo 'class="switch-1"'; } else { echo 'class="switch-2"'; }; ?>>
								...
								<?php } ?>
								<td data-title="<?php echo safe_output($language->get('Added')); ?>"><a href="<?php echo $config->get('address'); ?>/tickets/view/<?php echo (int) $ticket['id']; ?>/"><abbr title="<?php echo safe_output(time_ago_in_words($ticket['date_added'])); ?> <?php echo safe_output($language->get('ago')); ?>"><?php echo safe_output($ticket['date_added']); ?> </abbr></a></td>
								...
								<td data-title="<?php echo safe_output($language->get('Updated')); ?>">
									<a href="<?php echo $config->get('address'); ?>/tickets/view/<?php echo (int) $ticket['id']; ?>/"><abbr title="<?php echo safe_output($ticket['last_modified']); ?>"><?php echo safe_output(time_ago_in_words($ticket['last_modified'])); ?> <?php echo safe_output($language->get('ago')); ?></abbr></a>
								</td>
