					...
					<table class="table table-striped table-bordered">
						...
						<tr>
							<td data-title="<?php echo safe_output($language->get('Added')); ?>">
								<abbr title="<?php echo safe_output($item['date_added']); ?>"><?php echo safe_output(time_ago_in_words($item['date_added'])); ?> <?php echo safe_output($language->get('ago')); ?></abbr>
								- <?php echo safe_output($item['date_added']); ?>
							</td>
