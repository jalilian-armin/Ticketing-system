...
<div class="row">
	<div class="col-md-3">
		<div class="well well-sm">
			...
			<p class="right-result"><abbr title="<?php echo safe_output($user['date_added']); ?>"><?php echo safe_output(time_ago_in_words($user['date_added'])); ?> <?php echo safe_output($language->get('ago')); ?></abbr></p>	
			<div class="clearfix"></div>
