			...
			<div class="well well-sm">
				<?php if ($config->get('registration_enabled')) { ?>
					...
					<div class="col-lg-6">								
						...
						<p><?php echo safe_output($language->get('Email(optional)')); ?><br /><input class="form-control" type="email" name="email" value="<?php if (isset($_POST['email'])) echo safe_output($_POST['email']); ?>" /></p>					
