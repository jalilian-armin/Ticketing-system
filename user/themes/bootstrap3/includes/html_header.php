...
<head>
	...
	<link href="<?php echo $config->get('address'); ?>/user/themes/<?php echo safe_output(CURRENT_THEME); ?>/sub/<?php echo safe_output(CURRENT_THEME_SUB); ?>/css/bootstrap-flipped.css" rel="stylesheet">
	...
	<script type="text/javascript" src="<?php echo $config->get('address'); ?>/system/libraries/bootstrap-datetimepicker/1/bootstrap-datetimepicker.min.js"></script>
	<script type="text/javascript" src="<?php echo $config->get('address'); ?>/system/libraries/bootstrap-datetimepicker/1/bootstrap-datetimepicker.fa.min.js"></script>

 
	<link href="<?php echo $config->get('address'); ?>/system/libraries/bootstrap-datetimepicker/1/bootstrap-datetimepicker.min.css" rel="stylesheet">    
